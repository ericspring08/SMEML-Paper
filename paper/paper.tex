...
To evaluate our framework, we choose 7 different datasets of diverse size. We ran SMEML on each dataset for 32 iterations of tuning. We compared this against a "dumb" mode which simply runs every model on the dataset. We used the accuracy and time to train as our metrics.
...
\begin{table}
  ...
  \begin{tabular}{llllll}
    ...
    Dataset & \multicolumn{2}{c}{Accuracy} & \multicolumn{2}{c}{Time to Train} & Size (RxC)\\
