...
\begin{table}
  ...
  \begin{tabular}{lll}
    ...
    \hline
    Standard Deviation of IQR  & $\sigma \left\{\text{IQR of column}\right\}$ & Data Distribution \\
    \hline
    Mean Q1 & $\mu \left\{\text{Q1 of column}\right\}$ & Data Distribution \\
    \hline
    Standard Deviation of Q1  & $\sigma \left\{\text{Q1 of column}\right\}$ & Data Distribution \\
    \hline
    Mean Q3  & $\mu \left\{\text{Q3 of column}\right\}$ & Data Distribution \\
    \hline
    Standard Deviation of Q3  & $\sigma \left\{\text{Q3 of column}\right\}$ & Data Distribution \\
    \hline
    Mean Percent of Z-Score Outliers  & 
    $\mu \left\{ \frac{\text{\# of Z-Score Outliers}}{|\mathbf{A}|_r} \right\}$ & Outlier Data Points \\
    \hline
    Standard Deviation of Percent of Z-Score Outliers  &
    ...
    \hline
    Standard Deviation of Correlation & $\sigma \left\{\text{Correlation Matrix}\right\}$ & Data Linearity \\
    \bottomrule
  \end{tabular}
\end{table}

\subsection{Data Extraction}
To train our boosting model, we collected over a thousand datasets from kaggle, a popular website for hosting public datasets. After used various medical terms to filter down datasets and limiting our search to tabular, binary-classification datasets, we were left with 268 datasets. We extracted the attributes in Table 2. from each dataset and ran every model on each dataset to get the performace of each model. We trained a multilabel regression model on these attributes to predict the rank of every model on a specific dataset.
